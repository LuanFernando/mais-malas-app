          ...
          Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextFormFieldPersonalizado(controller.nomeProduto,
                      "Nome do produto", TextInputType.text),
                  _buildTextFormFieldPersonalizado(controller.descricaoProduto,
                      "Descrição do produto", TextInputType.text),
                  _buildTextFormFieldPersonalizado(controller.precoProduto,
...
//Componentização é reutilização de codigo,não sendo necessario criar inumeras vezes o mesmo widget.
  _buildTextFormFieldPersonalizado(TextEditingController nameController,
      var hintText, TextInputType textInputType) {
    return Padding(
